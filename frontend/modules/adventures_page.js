...
function generateFilterPillsAndUpdateDOM(filters) {
  ...
  durationOptions.value = filters.duration;  // for showing the selected duration in the box evan after refreshing the page
  ...
  for (let i = 0; i < filters.category.length; i++) {
    ...
    //pillsDiv.innerHTML += singlePill;  be carefull in this pllace , don't add pilsDiv.innerHTML
